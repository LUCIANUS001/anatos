    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-6 py-12 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-600">
            A complete anatomy learning system designed for medical,
            nursing and health science students. Learn structures,
            understand clinical applications and prepare for exams.
          </p>

          <div className="mt-8 flex flex-wrap gap-4">

            <button className="rounded-xl bg-sky-700 px-8 py-4 font-semibold text-white hover:bg-sky-800">
              Start Learning
            </button>

            <button className="rounded-xl border border-slate-300 px-8 py-4 font-semibold text-slate-700 hover:bg-white">
              Explore Courses
            </button>
          ...
          {systems.map((system) => (
            ...
            >
              ...
              <p className="mt-4 text-slate-600">
                Comprehensive lessons, practical resources,
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="rounded-3xl bg-white p-10 shadow">
          ...
          <p className="mt-4 text-slate-600">
            ...
            basic anatomy concepts to advanced clinical understanding.
          </p>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-2xl bg-sky-50 p-6">
              ...
              <p className="mt-3 text-slate-600">
                Learn bones, landmarks, articulations and clinical
            ...
            <div className="rounded-2xl bg-teal-50 p-6">
              ...
              <p className="mt-3 text-slate-600">
                Understand the brain, spinal cord, cranial nerves
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="rounded-3xl bg-gradient-to-r from-violet-700 to-sky-700 p-10 text-white">
          ...
          <p className="mt-4 max-w-3xl text-violet-100">
            Get explanations, revision summaries, practice questions
            and clinical insights while studying anatomy.
          </p>

          <button className="mt-8 rounded-xl bg-white px-8 py-4 font-semibold text-violet-700 hover:bg-slate-100">
            Try AI Tutor
          </button>
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="rounded-3xl bg-slate-900 p-10 text-white">
          ...
          <h2 className="text-4xl font-bold">
            Prepare for Your Anatomy Exams
          </h2>

          <p className="mt-4 max-w-3xl text-slate-300">
            Practice with mock examinations, flashcards, quizzes and
            revision tools designed for medical students.
          </p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="rounded-3xl bg-gradient-to-r from-sky-700 to-teal-600 p-10 text-center text-white">
          ...
          <button className="mt-8 rounded-xl bg-white px-10 py-4 font-bold text-sky-700">
            Get Started
          </button>
