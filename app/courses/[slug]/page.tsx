    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="mx-auto max-w-6xl px-6 py-10">
        <div className="rounded-3xl bg-gradient-to-r from-sky-700 to-teal-600 p-10 text-white">
          ...
          <h1 className="mt-6 text-5xl font-bold">Humerus</h1>

          <p className="mt-4 max-w-3xl text-cyan-100">
            Comprehensive study of the humerus including anatomy, relations,
            blood supply, ossification, muscle attachments, clinical anatomy and
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-3">
          <aside className="rounded-3xl bg-white p-8 shadow h-fit">
            <h2 className="text-2xl font-bold">Lesson Outline</h2>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="rounded-3xl bg-white p-8 shadow">
              <h2 className="text-3xl font-bold">Definition</h2>

              <p className="mt-5 leading-8 text-slate-700">
                The humerus is the longest bone of the upper limb. It extends
                from the shoulder to the elbow and forms articulations with the
                scapula, radius and ulna. It serves as an attachment site for
                numerous muscles and transmits neurovascular structures along
                the arm.
              </p>
            </div>

            <div className="rounded-3xl bg-white p-8 shadow">
              <h2 className="text-3xl font-bold">Anatomical Features</h2>

              <div className="mt-6 grid gap-4 md:grid-cols-2">
                <div className="rounded-xl bg-sky-50 p-5">• Head</div>

                <div className="rounded-xl bg-sky-50 p-5">
                  • Anatomical Neck
                </div>

                <div className="rounded-xl bg-sky-50 p-5">• Surgical Neck</div>
            ...
            <div className="rounded-3xl bg-white p-8 shadow">
              <h2 className="text-3xl font-bold">Muscle Attachments</h2>

              <ul className="mt-6 list-disc space-y-3 pl-6 leading-8 text-slate-700">
                <li>Deltoid → Deltoid Tuberosity</li>
                <li>
                  Pectoralis Major → Lateral Lip of Intertubercular Sulcus
                </li>
            ...
            <div className="rounded-3xl bg-white p-8 shadow">
              <h2 className="text-3xl font-bold">Blood Supply</h2>

              <p className="mt-5 leading-8 text-slate-700">
                The humerus receives its blood supply mainly from the nutrient
                artery and branches of the anterior and posterior circumflex
                humeral arteries.
              </p>
            </div>
            ...
            <div className="rounded-3xl bg-white p-8 shadow">
              ...
              <p className="mt-5 leading-8 text-slate-700">
                Fractures at the surgical neck commonly endanger the axillary
                nerve, while fractures of the radial groove may affect the
                radial nerve, leading to wrist drop.
              </p>
            </div>
