...
export default function BookmarksPage() {
  const [savedLessons, setSavedLessons] = useState<Bookmark[]>([]);
  const [savedFlashcards] = useState<string[]>([]);

  useEffect(() => {
    setSavedLessons(loadBookmarks());
  ...
  function removeBookmark(id: string, title: string) {
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        <div className="rounded-3xl bg-gradient-to-r from-amber-500 to-orange-500 p-10 text-white">
          ...
          <p className="mt-4 max-w-2xl text-orange-100">
            Access all your saved anatomy lessons, practical notes and favourite
            flashcards in one place.
          </p>
        </div>
        ...
        <div className="mt-10 grid gap-8 md:grid-cols-3">
          ...
          <div className="rounded-3xl bg-white p-6 shadow">
            ...
            <p className="mt-3 text-4xl font-bold text-teal-600">9</p>
          </div>
        </div>

        <div className="mt-10 grid gap-8 lg:grid-cols-2">
          <div className="rounded-3xl bg-white p-8 shadow">
            <h2 className="text-2xl font-bold">Saved Lessons</h2>
              ...
              {savedLessons.map((lesson) => (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      onClick={() => removeBookmark(lesson.id, lesson.title)}
          ...
          <div className="rounded-3xl bg-white p-8 shadow">
            <h2 className="text-2xl font-bold">Favourite Flashcards</h2>
